...
In the above plots, outliers are defined as values which exceed a certain distance from their nearest hinge (The hinges are comprised of the 1st and the 3rd quartiles). In this case, the distance in question is equal to 1.5 \* IQR, where IQR is the interquartile range. It is important to note that this method of defining outliers differs from the method which will be used during outlier removal.
